...
function Header({bgColor='bg-slate-100',textColor='text-gray-700 hover:text-blue-600', menu, setMenu}) {
    ...
    <section className={bgColor}>
      <div className={`py-3 lg:py-5 px-2 lg:px-5 ${bgColor!=='bg-transparent'?`border border-b-2`:`border-none`} flex justify-between`}>
        ...
        <ul className='hidden  lg:mr-20 lg:justify-end lg:flex lg:gap-10 lg:my-auto lg:ml-auto '>
          <li className={`font-medium ${textColor}  cursor-pointer`}><a href='/'>Home</a></li>
          ...
          <li className={`font-medium ${textColor}  cursor-pointer`}><a href='/aboutus'>About us</a></li>
